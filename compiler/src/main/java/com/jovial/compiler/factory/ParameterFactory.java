package com.jovial.compiler.factory;
...
public class ParameterFactory {
    ...
    public MethodSpec build(){return methodBuilder.build();}
    ...
    public void buildStatement(Element element){
        ...
        if(type == TypeKind.INT.ordinal()){
            ...
            }else if(typeUtils.isSubtype(typeMirror,callMirror)){//类型工具方法isSubtype类似instanceof
        ...
        if(methodContent.endsWith(")")){
            ...
            messager.printMessage(Diagnostic.Kind.NOTE,"目前暂支持String、int、boolean参数");
        }
    }
    ...
    public static class Builder{
        ...
        public ParameterFactory build(){
            if(parameterSpec == null){
                throw new IllegalArgumentException("parameterSpec方法参数 为空");
            }
            if(className == null){
                throw new IllegalArgumentException("方法内容中className为空");
            }
            if(messager == null){
                throw new IllegalArgumentException("messager对象为空");
            }
